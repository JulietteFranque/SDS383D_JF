...
class GibbsSampler:
    def __init__(self, X, y, time_vecs, n_iter=1000):
        self.X = X
        self.y = y
        ...
        self.cov_mats = self._initialize_cov_mats()
    ...
    def _update_tau_sq_1s_and_cov_mat(self):
    ...
    def fit(self):
        for it in tqdm(range(self.n_iter)):
            ...
            self._update_tau_sq_1s_and_cov_mat()
            self._update_taus()
            self._update_mu()
    ...
    def _update_traces(self, it):
        ...
        #  self.traces['sigmas_squared'][it, :] = [mat[0, 0] for mat in self.cov_mats]
