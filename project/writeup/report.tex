...
\begin{figure}[h!]\label{pymc1}
\centering
\includegraphics[width=.6\textwidth]{project/writeup/compare_gibbs_pymc1.png}
\caption{Traces for $\mu$ and $\mu_{jj}$}
\end{figure}


\begin{figure}[h!]\label{pymc2}
\centering
