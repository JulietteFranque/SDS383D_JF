...
\caption{ACF plots for all departments.}
\end{figure}

\section{Model}
Given the auto-correlation in the residuals for some departments, a joint hierarchical and Gaussian process model was used. The model was structured as follows:
