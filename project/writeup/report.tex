...
\begin{figure}[h]\label{corr_mat}
\centering
\includegraphics[width=.35\textwidth]{normal_approx_1.png}
\caption{Plots showing residuals with fitted normal with same moments (left), Q-Q plot (middle), residuals against time (right). Only the first 14 departments are shown.}
\end{figure}
